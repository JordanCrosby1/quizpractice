...
#Report 1
for school in schools: #school would be a dictionary in the list schools
...
for school in schools: #school would be a dictionary in the list schools
    ...
    if conf_number in conference_schools:
        ...
        if tuition: #same as saying if tuition is a null value, will only enter if not null
            if tuition > 60000:
                print(f"Name of University: {school['instnm']}")
